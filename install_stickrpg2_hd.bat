...
IF NOT EXIST flashplayer_32_sa.exe (
    %WINDIR%\System32\curl.exe -L -o flashplayer_32_sa.exe https://archive.org/download/adobe-flash-player-32.0.0.465-retail-debug/flashplayer_32_sa.exe REM only line that needs to be updated :P
)
